// Optional Interaction: Klik Frame Soli Deo
document.addEventListener('DOMContentLoaded', function () {
  const solideoFrame = document.getElementById('solideoFrame');
  solideoFrame.addEventListener('click', function() {
    alert("Soli Deo telah diklik!");
  });
